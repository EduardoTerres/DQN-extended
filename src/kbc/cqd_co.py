...
def limit_dataset(dataset, max_samples=100):
    ...
    dataset.type1_1chain = dataset.type1_1chain[:max_samples]
    dataset.type1_2chain = dataset.type1_2chain[:max_samples]
    dataset.type2_2chain = dataset.type2_2chain[:max_samples]
    dataset.type2_2chain_u = dataset.type2_2chain_u[:max_samples]
    dataset.type1_3chain = dataset.type1_3chain[:max_samples]
    dataset.type2_3chain = dataset.type2_3chain[:max_samples]
    dataset.type3_3chain = dataset.type3_3chain[:max_samples]
    dataset.type4_3chain = dataset.type4_3chain[:max_samples]
    dataset.type4_3chain_u = dataset.type4_3chain_u[:max_samples]
    return dataset
